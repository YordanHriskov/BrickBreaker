...
public interface Constants {
	...
	public static final int WINDOW_CENTER_LEFT = 350;
	...
	public static final int END_GAME_LABEL = WINDOW_HEIGHT - 350;
	public static final int SCORE_LABEL = WINDOW_HEIGHT - 320;
